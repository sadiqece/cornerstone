...
class learner_info(osv.osv):
	...
	_columns = {
		...
		'module_line': fields.one2many('enroll.module.line','learner_info_id','Module'),
...
class enroll_module_line(osv.osv):
	...
	'learner_info_id': fields.many2one('learner.info', 'Learner', ondelete='cascade', help='Learner', select=True),
